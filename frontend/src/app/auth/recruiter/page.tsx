...
export default function RecruiterTransitionScreen() {
    ...
    <AuthLayout showNavbar={true}>
      ...
      <ScreenTransition>
        <div className="transition-screen">
          <div className="transition-watermark">RECRUITER</div>
          ...
          <div className="transition-content">
            ...
            >
              ...
              <div>
                Only verified companies are granted platform access. Unverified
                accounts are automatically suspended within 24 hours of creation.
              </div>
            </div>
